    ...
    <div class="movie-grid">
        ...
        <%
            if (movieList != null
                ...
                for (Document movie : movieList) {
                    ...
                    String title =
                        movie.getString("title") != null
                        ? movie.getString("title")
                        : "Untitled";

                    String poster =
                        movie.getString("poster_url") != null
                        ? movie.getString("poster_url")
                        : "";

                    String genre =
                        movie.getString("genre") != null
        ...
        <div class="movie-card"
            ...
            <div class="movie-card-img-wrap">
                ...
                <img
                    src="<%= request.getContextPath() %>/<%= poster %>"
                    alt="<%= title %>">
